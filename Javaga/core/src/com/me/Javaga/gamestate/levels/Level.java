...
public enum Level {
	...
	LEVEL1(
			new StageDescription[]{
					...
					new StageDescription(EnemyDescription.HEAVY_ENEMY,
					...
					new StageDescription(EnemyDescription.STANDARD_ENEMY,
							EnemyMovement.MOVEMENT8, 5, 0),
					new StageDescription(EnemyDescription.STANDARD_ENEMY,
							EnemyMovement.MOVEMENT9, 5, 10),
					new StageDescription(EnemyDescription.BOSS1,
							EnemyMovement.MOVEMENT7, 1, -1)
			}
	),
	LEVEL2(
			new StageDescription[]{new StageDescription(EnemyDescription.FAST_ENEMY,
					EnemyMovement.MOVEMENT7, 1, 20),
					new StageDescription(EnemyDescription.FAST_ENEMY,
							EnemyMovement.MOVEMENT8, 1, 20),
					new StageDescription(EnemyDescription.FAST_ENEMY,
							EnemyMovement.MOVEMENT9, 1, -1),
					new StageDescription(EnemyDescription.BOMB_ENEMY,
					...
					new StageDescription(EnemyDescription.FAST_ENEMY,
							EnemyMovement.MOVEMENT4, 1, -1),
					new StageDescription(EnemyDescription.BOSS2,
							EnemyMovement.MOVEMENT6, 1, -1)
			}
	),
	LEVEL3(
			new StageDescription[]{new StageDescription(EnemyDescription.HEAVY_ENEMY,
					...
					new StageDescription(EnemyDescription.BOSS3,
							EnemyMovement.MOVEMENT6, 1, -1)
			}
	),
	LEVEL4(
			new StageDescription[]{
					new StageDescription(EnemyDescription.BOMB_SHIELD,
							EnemyMovement.MOVEMENT1, 1, 0),
					new StageDescription(EnemyDescription.BOMB_ENEMY,
							EnemyMovement.MOVEMENT1, 1, 3),
					new StageDescription(EnemyDescription.BOMB_SHIELD,
							EnemyMovement.MOVEMENT1, 3, 0),
					new StageDescription(EnemyDescription.BOMB_ENEMY,
							EnemyMovement.MOVEMENT1, 3, 3),
					new StageDescription(EnemyDescription.BOMB_SHIELD,
							EnemyMovement.MOVEMENT1, 5, 0),
					new StageDescription(EnemyDescription.BOMB_ENEMY,
							EnemyMovement.MOVEMENT1, 5, 3),
					new StageDescription(EnemyDescription.BOMB_SHIELD,
					...
					new StageDescription(EnemyDescription.STANDARD_ENEMY,
							EnemyMovement.MOVEMENT4, 3, -1),
					new StageDescription(EnemyDescription.BOSS4,
							EnemyMovement.MOVEMENT1, 1, -1)
			}
	),
	LEVEL5(
			new StageDescription[]{
					new StageDescription(EnemyDescription.STANDARD_SHIELD,
					...
					new StageDescription(EnemyDescription.HEAVY_SHIELD,
							EnemyMovement.MOVEMENT8, 5, 0),
					new StageDescription(EnemyDescription.HEAVY_ENEMY,
							EnemyMovement.MOVEMENT8, 5, 0),
					new StageDescription(EnemyDescription.HEAVY_SHIELD,
					...
					new StageDescription(EnemyDescription.BOSS_SHIELD,
							EnemyMovement.MOVEMENT6, 1, 0),
					new StageDescription(EnemyDescription.BOSS_SHIELD,
							EnemyMovement.MOVEMENT6, 1, 0),
					new StageDescription(EnemyDescription.BOSS5,
							EnemyMovement.MOVEMENT6, 1, -1)
			}
	);
